                    ...
                    if (b == true)
                    {
                        switch (ObrD.tipName)
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    await (SaveFileDelegate?.Invoke(data1, dataTail1, time1, ObrD.NameFile, false)).ConfigureAwait(false);
                                }
            ...
            try
            {
                ...
                switch (tipN)
                {
                    ...
                    case "V":
                            ...
                            firstTimeN = ObrabotcaURAN.Obrabotca.FirstTme(maxTime, maxAmp, data1, Nul, ref PolovmaxTime, out Amp34, out Amp14);



                            sumSig = ObrabotcaURAN.Obrabotca.ColSigVatias(data1, Nul);
                            sumBB = ObrabotcaURAN.Obrabotca.ColBin(data1, Nul);
